...
<body>
        ...
        <tr>
            <td>
                <table border="0" cellpadding="15"
                    ...
                    <tr>
                        <td width="40%">
                            <img src="///C:/Users/laxmi/Downloads/LaxmiRH.jpg">
                        </td>
                        ...
                        <td width="60%">
                            <font face="Verdana" size="4"
                                ...
                                website.
                                <hr color="black">
                                Laxmi Hanajanatti student at
					  KLS Gogte institute of technology . she
    ...
    <!--Resume(start)-->
    <table id="Resume" border="0" width="100%"
        ...
        <tr>
            <td>
                <table border="0" cellpadding="15"
					...
					<div class ="Contant">
						<h2> Contact</h2>
						<p><b>Email id:</b>laxmihanajanatti123@gmail.com</p>
						<p><b>Mobile no:</b>8884709424</p>
					</div>
					<div class="Skills">
						<h2>Skills</h2>
					<ul>
						<li><b>Programming Language:
							C, C++ ,Java ,frontand web development</b></li>
						...
						<table>
							...
							<tr>
								...
								<td>8.55 CGPA</td>
                                          ...
                                          <tr>
								<td>Alvas PU college</td>
								<td>2021</td>
								<td>100%</td>
							</tr>
                                          <tr>
								<td>Alvas Kannada Medium School</td>
								<td>2019</td>
								<td>97%</td>
							</tr>
						</table>
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                got 25% scholarship in aptitude test.
                                            </li>
                                        </ul>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                Attended events and workshops on
